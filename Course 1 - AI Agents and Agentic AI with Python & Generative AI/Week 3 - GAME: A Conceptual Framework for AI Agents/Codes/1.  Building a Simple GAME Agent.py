...
class AgentJsonActionLanguage(AgentLanguage):
    ...
    def parse_response(self, response: str) -> dict:
        ...
        try:
            ...
            json_str = stripped_response[start_index +
...
def main():
    ...
    goals = [
        ...
        Goal(priority=1,
             name="Terminate",
             description=
             "Call the terminate call when you have read all the files "
    ...
    def list_project_files() -> List[str]:
        return sorted(
            [file for file in os.listdir(".") if file.endswith(".py")])
    ...
    action_registry.register(
        Action(name="terminate",
               ...
               description=
               "Terminates the session and prints the message to the user.",
               parameters={
                   "type": "object",
                   "properties": {
                       "message": {
    ...
    agent = Agent(goals, agent_language, action_registry, generate_response,
                  environment)
